...
class cafetera(var capacidad: Double, var cantidad: Double, var ubicacion: String) {

    val capacidadMax = 1000.0
    val cantidadIni = 0.0


    constructor(capacidad: Double, ubicacion: String) : this(capacidad, ubicacion) {

    }
    constructor(capacidad: Double, ubicacion: String, cantidad: Double) : this(ubicacion, capacidad, cantidad.toString()){

    }

    fun llenar(capacidad: Int){
        var llenarCafe = cantidad.toInt() == capacidad

    }
    fun vaciar(cantidad: Int){
        var vaciarCafe = cantidad == 0
    }
    fun agregarCafe() {
    ...
    override fun toString(): String {
        return "Cafetera que está en ${ubicacion}, tiene una capacidad de ${capacidad} y cantidad de ${cantidad}."
    }
}
